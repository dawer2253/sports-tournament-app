...
return [
    ...
    */
    ...
    //
    // `localhost` i `127.0.0.1` to dla przeglądarki dwa różne originy, a Vite
    // bywa otwierany raz tak, raz tak. Oba warianty są tu po to, żeby preflight
    // nie odbijał zależnie od tego, co komu wkleiło się do paska adresu.
    'allowed_origins' => [
        'http://localhost:5173',
        'http://localhost:5174',
        'http://127.0.0.1:5173',
